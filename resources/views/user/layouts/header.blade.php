...
<!-- navbar-->
    <header class="header mb-5">
      ...
      *** TOPBAR ***
          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              ...
              @if(isset(Auth::guard('user')->user()->name))
                ...
                <li class="list-inline-item"><a href="{{route('customeraccount')}}"> {{Auth::guard('user')->user()->name}} </a></li>
              @else
      ...
      {{-- @php $carturl="javascript:" @endphp
      @if(Auth::guard('user')->check()) --}}
       @php $carturl=route('cart') @endphp
      {{-- @endif --}}
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="{{route('home')}}" class="navbar-brand home"><img src="{{asset('assets/dist/img/'.$websitecontact['website_logo'])}}" alt="{{$websitecontact['website_name']}} logo" class="d-none d-md-inline-block"><img src="{{asset('assets/user/img/logo-small.png')}}" alt="{{$websitecontact['website_name']}} logo" class="d-inline-block d-md-none"><span class="sr-only">{{$websitecontact['website_name']}} - go to homepage</span></a>
          <div class="navbar-buttons">
            ...
            <a href="{{$carturl}}" class="btn btn-outline-secondary navbar-toggler"><i class="fa fa-shopping-cart"></i><span class='badge badge-danger lblCartCount'>{{$cartcount}}</span></a>
          </div>
          <div id="navigation" class="collapse navbar-collapse">
                ...
                <ul class="dropdown-menu megamenu">
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="banner"><a href="#"><img src="{{asset('assets/user/img/banner.jpg')}}" alt="" class="img img-fluid"></a></div>
                        <div class="banner"><a href="#"><img src="{{asset('assets/user/img/banner2.jpg')}}" alt="" class="img img-fluid"></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-3">
                        ...
                        <ul class="list-unstyled mb-3">
                          ...
                          <li class="nav-item"><a href="{{route('productlist')}}" class="nav-link">Category</a></li>
                        </ul>
                      </div>
                      <div class="col-md-6 col-lg-3">
                        <h5>User</h5>
                        <ul class="list-unstyled mb-3">
                          <li class="nav-item"><a href="{{$carturl}}" class="nav-link">Shopping cart</a></li>
                          <li class="nav-item"><a href="{{route('orders')}}" class="nav-link">Order history</a></li>
                          <li class="nav-item"><a href="{{route('customeraccount')}}" class="nav-link {{ Request::is('customer-account') ? 'active' : '' }}">Customer account</a></li>
                          <li class="nav-item"><a href="{{route('user.changepassword')}}" class="nav-link">Change password</a></li>
                        </ul>
                      </div>
                      {{-- <div class="col-md-6 col-lg-3">
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="{{$carturl}}" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="lblCartCount">{{$cartcount}}</span><span> items in cart</span></a></div>
            </div>
          </div>
        </div>
      </nav>
      <div id="search" class="collapse">
        <div class="container">
          <form role="search" action="{{route('productlist')}}" method="post" class="ml-auto">
          @csrf
