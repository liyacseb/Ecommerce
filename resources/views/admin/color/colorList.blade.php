...
@php
    $breadcrumbs = [['title' => 'Color List','route' =>null ]];
@endphp
...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <a href="{{route('colorcreate')}}" class="btn btn-primary"   title="Add new Color">
      Add Color
      </a>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        //     ],
        ajax: "{{ route('colorListing') }}",
        columns: [
            {data: 'DT_RowIndex', name: '', orderable: false, searchable: true,sWidth: '20'},
            {data: 'color', name: 'color',orderable: true, searchable: true,sWidth: '70%'},
