...
@php
    $breadcrumbs = [['title' => 'Tax List','route' =>null ]];
@endphp
...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <a href="{{route('taxcreate')}}" class="btn btn-primary"   title="Add new Tax">
      Add Tax
      </a>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        //     ],
        ajax: "{{ route('taxListing') }}",
        columns: [
            {data: 'DT_RowIndex', name: '', orderable: false, searchable: true,sWidth: '20'},
            {data: 'name', name: 'name',orderable: true, searchable: true,sWidth: '35%'},
            {data: 'tax', name: 'tax',orderable: true, searchable: true,sWidth: '35%'},
