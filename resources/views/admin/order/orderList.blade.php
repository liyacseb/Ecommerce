...
@php
    $breadcrumbs = [['title' => 'Order List','route' =>null ]];
@endphp
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        //     ],
        ajax: "{{ route('orderListing') }}",
        columns: [
            {data: 'DT_RowIndex', name: '', orderable: false, searchable: true,sWidth: '10'},
            {data: 'ordernumber', name: 'ordernumber',orderable: true, searchable: true,sWidth: '10%'},
            {data: 'userdetails', name: 'userdetails',orderable: true, searchable: true,sWidth: '20%'},
            {data: 'grand_total', name: 'grand_total',orderable: true, searchable: true,sWidth: '15%'},
            {data: 'paidstatus', name: 'paidstatus',orderable: true, searchable: true,sWidth: '10%'},
            {data: 'orderstatus', name: 'orderstatus',orderable: true, searchable: true,sWidth: '15%'},
            {data: 'date', name: 'date',orderable: true, searchable: true,sWidth: '10%'},
