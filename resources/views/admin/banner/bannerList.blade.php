...
@php
    $breadcrumbs = [['title' => 'Banner List','route' =>null ]];
@endphp
...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <a href="{{route('bannercreate')}}" class="btn btn-primary"   title="Add new Banner">
      Add Banner
      </a>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        //     ],
        ajax: "{{ route('bannerListing') }}",
        columns: [
            {data: 'DT_RowIndex', name: '', orderable: false, searchable: true,sWidth: '20'},
            {data: 'bannerimg', name: 'bannerimg',orderable: true, searchable: false,sWidth: '35%'},
            {data: 'bannerstatus', name: 'bannerstatus',orderable: true, searchable: true,sWidth: '35%'},
