...
@php
    $breadcrumbs = [['title' => 'Banner List','route' =>route('bannerList') ],['title' => 'Banner Edit','route' =>null ]];
@endphp
...
<section class="content">
    <form method="post" id="bannerupdateform" enctype="multipart/form-data">
        @csrf
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <label for="status">Status <span class="text-danger" id="statusErr"></span></label>
                  <select name="status" id="status" class="form-control custom-select">
                      <option selected disabled>Select one</option>
                    @foreach($array['status'] as $key => $ans )
                      @php $selected = ''; @endphp
                      @if($curntdata['status']==$key)
                ...
                <div class="col-md-6">
                  ...
                  @if($curntdata['banner_img'])  @php $imgUrl = asset('storage/banner/'.$curntdata['banner_img']) @endphp  @endif                 
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" id="updbtn" value="Update" class="btn btn-success float-right">
        </div>
      </div>
    </form>
...
const checkurl="{{route('availableBannerCheck')}}";
const storeurl="{{route('bannerupdate',$curntdata['id'])}}";
</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/jquery.validate.min.js"></script>
